            ...
            <div style={{ position: 'relative' }}>
                <div>
                    ...
                    <p style={globals.paragraph}>
                        How do statements relate to each other? Did people who agreed with one
                        comment also agree with another?
                    </p>
                    <p style={globals.paragraph}>
                        In this graph, statements that met disagreement are closer together if they
                        were voted on similarly. Those statements which were voted on differently
                        are further apart.
                    </p>
                    <p style={Object.assign({}, globals.paragraph, { fontStyle: 'italic' })}>
                        This is important because it is the basis on which we will lay out and
                        cluster participants in a 2d space in later steps (closer to the statements
                        on which they agreed). There are no meaningful axes, but there are regions
                        of statements that lend a certain personality to a given area.
                    </p>
                </div>
                <p style={{ fontWeight: 500, maxWidth: 600, lineHeight: 1.4, minHeight: 50 }}>
                    {this.state.selectedComment
                        ? '#' +
                          this.state.selectedComment.tid +
                          '. ' +
