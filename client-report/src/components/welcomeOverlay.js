    ...
    return (
        ...
        >
            <div className={'w-[40rem]'}>
                ...
                <p className={'mb-2'}>
                    Via de navigatie aan de bovenkant beweeg je door de resultaten heen. Is het niet
                    duidelijk? Via het vraagteken rechtsonder krijg je informatie over waar je
                    precies naar kijkt.
                </p>
