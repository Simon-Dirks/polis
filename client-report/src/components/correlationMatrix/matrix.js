                ...
                markup = (
                    <g key={column}>
                        <text
                            ...
                            fill={
                                column === this.state.mouseOverColumn ||
                                column === this.state.mouseOverRow
                                    ? 'rgba(0,0,0,1)'
                                    : 'rgba(0,0,0,0.5)'
                            }
                            style={{
        ...
        return (
            <div>
                ...
                <p style={globals.paragraph}>
                    ...
                    comment also agreed (or disagreed) with another given comment?
                </p>
                <p style={globals.paragraph}>
                ...
                <p style={globals.paragraph}>
                    This is an important bit of math (called a correlation matrix) that goes into
                    making the graph above.
                </p>
                ...
                <svg width="100%" height={side} style={{ cursor: 'crosshair' }}>
                    ...
                    <g
                        transform={
                            'translate(200,0), rotate(45)' /* abstract translate magic number */
                        }
                    >
