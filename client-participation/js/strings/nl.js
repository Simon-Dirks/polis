...
s.helpWhatDoIDo = "Stem op andere stellingen door op 'akkoord' of 'niet akkoord' te klikken. Schrijf een stelling (blijf kort en bondig, één idee per lijn). Nodig vrienden uit om deel te nemen aan de discussie!";
s.writeCommentHelpText = "<strong>schrijf</strong> een stelling indien uw mening niet wordt vertegenwoordigd</i>";
...
s.pctAgreedLong = "{{pct}}% van alle deelnemers is het eens met stelling {{comment_id}}.";
s.pctAgreedOfGroup = "{{pct}}% van Groep {{group}} is het eens";
s.pctDisagreedOfGroup = "{{pct}}% van Groep {{group}} is het oneens";
s.pctDisagreedLong = "{{pct}}% van alle deelnemers is het oneens met stelling {{comment_id}}.";
s.pctAgreedOfGroupLong = "{{pct}}% van Groep {{group}} is het eens met stelling {{comment_id}}.";
s.pctDisagreedOfGroupLong = "{{pct}}% van Groep {{group}} is het oneens met stelling {{comment_id}}.";
...
s.commentSendFailedDuplicate = "Er was een fout bij het toevoegen van uw stelling - deze stelling bestaat al.";
...
s.tipCommentsRandom = "Stellingen zijn willekeurig gesorteerd. U bent op niemand aan het reageren";
s.tipOneIdea = "Splits lange stellingen op in verschillende ideeën. Dit maakt het makkelijker voor anderen om te stemmen.";
s.tipNoQuestions = "Probeer vragen in uw stellingen te vermijden. Deelnemers zullen vervolgens al dan niet akkoord gaan met uw stelling.";
s.commentTooLongByChars = "De lengte van uw stelling werd met  {{CHARACTERS_COUNT}} karakters overschreden.";
...
s.participantHelpGroupsText = "Als veel mensen hetzelfde stemmen op bepaalde stellingen, ontstaat een meningengroep. Kijk waar jij staat ten opzichte van andere meningen.";
...
s.notificationsEnterEmail = "Vul uw emailadres in om op de hoogte gesteld te worden van nieuwe stellingen:";
s.labelEmail = "Email";
